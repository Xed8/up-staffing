    ...
    <div className="bg-cream min-h-screen">
      ...
      <nav className="sticky top-0 z-50 bg-cream border-b border-[rgba(0,0,0,0.08)]">
        <div className="max-w-350 mx-auto px-6 md:px-12 h-14 flex items-center justify-between">
          <span className="font-jost text-[13px] tracking-widest uppercase text-ink">
            UpVirtual
          </span>
          ...
          <a href="#" className="font-jost text-[12px] tracking-[0.12em] uppercase text-ink border border-[rgba(26,26,26,0.25)] px-4 py-2 hover:bg-ink hover:text-cream transition-colors">
            Get Started
          </a>
        </div>
      </nav>
